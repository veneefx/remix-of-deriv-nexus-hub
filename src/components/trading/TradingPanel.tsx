    ...
    <div className="flex h-full">
      ...
      <div
        className={`bg-card/95 backdrop-blur-lg overflow-y-auto border-border ${
          mobileSheetOpen
            ? "fixed left-0 bottom-24 top-24 z-50 w-[50%] min-w-[240px] max-w-[280px] rounded-r-2xl border-r shadow-2xl block animate-in slide-in-from-left duration-300 lg:relative lg:inset-auto lg:max-w-none lg:w-[320px] lg:rounded-none lg:border-l lg:border-r-0 lg:shadow-none lg:animate-none"
